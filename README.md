...
- Optional cross-app global lookup: after configuring the shortcut and granting Accessibility permission, selected text in webpages, PDFs, or other apps can open the active Profile's Niratan popup.
