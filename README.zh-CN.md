...
<img src="Assets.xcassets/NiratanSidebarIcon.imageset/niratan-sidebar-icon.png" width="128" alt="Niratan 图标">
...
- 支持可选的跨 App 全局查词：配置快捷键并授权辅助功能后，可在网页、PDF 或其他 App 中对选中文本呼出当前 Profile 的 Niratan 查词弹窗。
