...
- SRT/VTT parsing, ASS/SSA Dialogue text extraction, overlapping cue lookup and Hoshi-owned subtitle overlay.
...
| P0 | External SRT/VTT/ASS/SSA and embedded text subtitle lookup overlay | Implemented |
