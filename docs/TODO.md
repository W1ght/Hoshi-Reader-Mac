...
- Next low-risk candidate: auth presentation after manual Google login validation is available, or begin native macOS target planning before replacing Catalyst bridges with AppKit.
