...
clang++ -DHOSHI_VIDEO -fobjc-arc -I Vendor/libmpv/include -I . -c Features/Video/Playback/HSMpvClient.mm -o /tmp/HSMpvClient.o && xcrun swiftc -D HOSHI_VIDEO -parse-as-library -import-objc-header Features/Video/Playback/HoshiVideo-Bridging-Header.h -Xcc -DHOSHI_VIDEO=1 Features/Video/VideoMediaTypes.swift Features/Video/VideoLibraryStore.swift Features/Video/VideoThumbnailStore.swift script/test_video_thumbnail_store.swift /tmp/HSMpvClient.o -I Vendor/libmpv/include -L Vendor/libmpv/lib -lmpv -lc++ -Xlinker -rpath -Xlinker "$PWD/Vendor/libmpv/lib" -framework AppKit -framework OpenGL -o /tmp/test_video_thumbnail_store && /tmp/test_video_thumbnail_store
xcrun swiftc -D HOSHI_VIDEO -parse-as-library Models/Subtitle.swift Features/Video/Playback/PlaybackEngine.swift Features/Video/VideoMediaTypes.swift Features/Video/VideoPlaybackHistoryStore.swift Features/Video/VideoLibraryStore.swift Features/Video/VideoThumbnailStore.swift Features/Video/VideoLibraryViewModel.swift script/test_video_library_view_model.swift -o /tmp/test_video_library_view_model && /tmp/test_video_library_view_model
